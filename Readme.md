<!-- default badges list -->
![](https://img.shields.io/endpoint?url=https://codecentral.devexpress.com/api/v1/VersionRange/283966282/25.2.3%2B)
...
This example sends parameters from the client side to the report displayed in the Document Viewer.
...
Navigate to the *PassParameterExample/PassParameterExample.Server* folder and use the following command to restore dependencies and run the application:

```console
cd PassParameterExample/PassParameterExample.Server
dotnet run
```
